...
// how do we add the array numbers together, when the array could be any length?
// devided by would just be / by arr.length. Does arr.sum exist? - no haha
// so what about a for loop that adds the number from the array each time
