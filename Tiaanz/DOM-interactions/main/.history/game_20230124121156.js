...
function makeGreen(evt) {
  evt.preventDefault();
  evt.target.classList[1] == 'invisible' ? null:  evt.target.classList.toggle("green");
...
function makeBlue(evt) {
  evt.target.classList[1] == 'invisible' ? null:  evt.target.classList.toggle("blue");
...
function hide(evt) {
  ...
  evt.target.classList[1] == 'invisible' ? null: evt.target.classList.toggle("invisible");
  // evt.target.classList.remove('green')
  evt.target.classList.remove("blue");
  updateCounts();
}
