...
//
// 4. Define a function named `countShortNames` that takes an argument array of strings and returns a count of all the strings with a length less than 5.
...
function countShortNames(names) {
  let count = 0
...
function everySecoindItem(items) {
  const result = []
