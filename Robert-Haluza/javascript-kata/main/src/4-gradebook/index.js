...
students.forEach((student, i) => {
  ...
  gradebook[student].testScores = scores[i]
})
...
function enterScores(gradebook, students, scores) {
  let newGradebook = {}
  students.forEach((student, i) => {
    newGradebook[student] = {}
    newGradebook[student].testScores = scores[i]
  })
  return newGradebook
}
// let newGradebook = enterScores(gradebook, students, scores)
