...
let terah = {
  ...
  hairColor: 'brown',
  eyeColor: 'brown',
  // children:{ben:{name:'ben'},wilson:{name:'wilson'}}
}
...
adam = { name: 'Adam' }
// 3. Add a spouse key to the adam object and assign it the value of terah.s
let te = { spouse: terah }
Object.assign(adam, te)
// 4. Add a "spouse" key to terah and assign it the value of adam.
let ad = { spouse: adam }
Object.assign(terah, ad)
...
let ch = {}
childrenKey = { children: ch }
Object.assign(terah, childrenKey)
...
childrenAdam = { children: terah.children }
Object.assign(adam, childrenAdam)
// Object.assign(adam, childrenAdam)
