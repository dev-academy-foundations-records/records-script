...
function updateCounts () {
 ...
 let blueCount = document.getElementsByClassName('blue');
    totals.blue = blueCount.length;
 let greenCount = document.getElementsByClassName('green');
    totals.green = greenCount.length;
 let invisibleCount = document.getElementsByClassName('invisible');
