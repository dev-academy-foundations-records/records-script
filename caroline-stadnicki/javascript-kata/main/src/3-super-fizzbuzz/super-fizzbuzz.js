...
// We can use the function from last exercise to map the elements of the arrayParameter and return
// the result into the new array called fizzbuzzed.


function superFizzbuzz(arrayParameter) {
    
    let fizzbuzzed = arrayParameter.map(fizzbuzz)
