...
let jiho = {
  ...
  age: '1992',
  sport: "running",
  quote: "I want to get higher payment"
}
athleteArray.push(jiho);
...
for (let i = 0; i < athleteArray.length; i++) {
  athleteArray[i].win = () => console.log(`${athleteArray[i].name} won the ${athleteArray[i].sport} event!`);
}
...
function newAthlete (name, age, sport, quote) {
  return {
    ...
    sport: sport,
    quote: quote,
    win: () => console.log(`${name} won the ${sport} event!`)
  }
}
