...
//for every student element, add new key to gradebook with empty value

function addStudentScore(students, scores) {
...
addStudentScore(students, scores)
...
function addScore(studentName, num) {
  gradebook[studentName].testScores.push(num)
  return gradebook
}
...
function getAverage(studentName) {
  let studentScores = average(gradebook[studentName].testScores)
