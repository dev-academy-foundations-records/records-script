...
function countShortNames(strings) {
  let array = []
...
// let name = ['henry', 'bob', 'Alice', 'Sue']

// function countShortNames(array) {
//   for (let name of countShortNames) {
//     return countShortNames.length < 5
//   }
// }
...
function everySecondItem(items) {
  let count = 0
  let newItems = []
